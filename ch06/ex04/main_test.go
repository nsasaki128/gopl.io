...
func TestElems(t *testing.T) {
	testCases := []struct {
		...
		{name: "empty", input: toIntSet([]int{}...), expected: []uint64{}},
		{name: "1 input", input: toIntSet([]int{1}...), expected: []uint64{1}},
		{name: "many input", input: toIntSet([]int{1, 2, 63, 64, 256}...), expected: []uint64{1, 2, 63, 64, 256}},
	}
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
